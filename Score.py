...
if uploaded_file is not None:
  ...
  if genScore:
      ...
      # Initialize scores
        ...
        if df.shape[0] > 0:
          df['Total Score'] = name_score + classification_score + compliance_score + standard_score + desc_score + price_score + packaging_score + validity_score + indication_score + contraind_score + benefits_score + directions_score + demo_score + composition_score + image_score + image_quality_score + video_score + stores_score + support_score + origin_score + practice_score
          # Add image score 
